...
function printDocument(title, content, targetWindow = null) {
  ...
  popup.document
    ...
    @page{size:A4 landscape;margin:12mm}*{box-sizing:border-box}body{font-family:Arial,sans-serif;color:#0f172a;margin:0}h1{margin:0 0 4px;font-size:22px}p{margin:3px 0;color:#475569}.head{display:flex;justify-content:space-between;gap:20px;padding-bottom:14px;border-bottom:2px solid #f97316}.meta{text-align:right}.summary{display:flex;gap:18px;margin:14px 0;padding:12px;background:#fff7ed;border-radius:10px}.summary b{display:block;font-size:17px}.summary span{font-size:11px;color:#475569}table{width:100%;border-collapse:collapse;margin-top:14px;font-size:11px}th{padding:9px 7px;text-align:left;color:#fff;background:#c2410c}td{padding:8px 7px;border-bottom:1px solid #e2e8f0;vertical-align:top}.right{text-align:right}.badge{display:inline-block;padding:4px 7px;border-radius:999px;color:#9a3412;background:#ffedd5;font-weight:bold}.foot{margin-top:22px;padding-top:12px;border-top:1px solid #e2e8f0;font-size:10px;color:#475569}.no-print{margin:15px 0;padding:8px 14px;border:0;border-radius:8px;color:#fff;background:#f97316;font-weight:700;cursor:pointer}@media print{.no-print{display:none}}
